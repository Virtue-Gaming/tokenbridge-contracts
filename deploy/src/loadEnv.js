...
const completeBridgeModes = ['NATIVE_TO_ERC', 'ERC_TO_ERC', 'ERC_TO_NATIVE', 'INVERTED_NATIVE_TO_ERC']
const validBridgeModes = [...completeBridgeModes, 'TOKEN_ONLY']
